...
__C.DEVICE = 'cuda' if __C.CUDA else 'cpu'
...
# ------------------------------------------------------------------------ #
# Template refining options
# ------------------------------------------------------------------------ #
__C.REFINE_TEMPLATE = CN()

__C.REFINE_TEMPLATE.METHODS = ('OFF', 'LINEAR', 'NETWORK')

__C.REFINE_TEMPLATE.METHOD = 'OFF'

__C.REFINE_TEMPLATE.LINEAR = CN()

__C.REFINE_TEMPLATE.LINEAR.RATE = 0.01

__C.REFINE_TEMPLATE.NETWORK = CN()

__C.REFINE_TEMPLATE.NETWORK.MODEL = 'Refine3L'

__C.REFINE_TEMPLATE.NETWORK.CHECKPOINT = r''

__C.REFINE_TEMPLATE.COLLECT_DATASET = False

__C.REFINE_TEMPLATE.FEATURE_SIZE = [1, 256, 6, 6]